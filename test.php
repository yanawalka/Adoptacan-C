...
<body>
    ...
    <div class="tarjNosotros mt-5">
        <div class="shadow-sm  shadow-lg p-3 mb-5 pb-3 bg-body rounded">
            ...
            <div class="row">
                ...
                <div class="col ">
                    <h3 class=" requisitos ps-3 pb-2 pt-3 fw-lighter">REQUISITOS</h3>
                    <ul class="text-secondary p-1 text-right ps-5">
                        <li class="pb-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ullam provident
                            animi
                            enim. Eum delectus
                            iusto
                            a. Quidem perferendis inventore necessitatibus, mollitia cum id, quo odio excepturi,
                            eaque
                            perspiciatis
                            natus ipsam.</li>
                        <li class="pb-3">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Praesentium
                            dolore
                            excepturi delectus
                            assumenda. Suscipit, asperiores in ex temporibus sunt, corporis repellendus, amet
                            voluptatibus
                            obcaecati
                            sint quasi non accusantium architecto voluptates!</li>
                        <li class="pb-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minus quia amet
                            sapiente
                            eaque dolores
                            tenetur
                            dolore quos aperiam labore voluptatem facere, voluptatibus laudantium est delectus harum
                            necessitatibus
                            perspiciatis sequi quo?</li>
                    </ul>
                </div>
                <div class="col d-none d-lg-block"><img src="src/caschi3.jpg" class="img-fluid" ></div>
            </div>
        </div>
    </div>
    ...
    include 'bd/conexion.php';
      $personal = oci_parse($conn,"SELECT p.ID, p.APODO, p.SEXO, p.FECHANAC ,r.NOMBRE FROM PERROS p INNER JOIN RAZAS r ON p.RAZA_ID=r.ID");
                        ...
                        <div class="card h-100" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn-primary"
                                    href="vistas/descPerrito.php?<?php echo "ID=".$fila['ID'] ?>">Descripcion
                                    detallada</a>
