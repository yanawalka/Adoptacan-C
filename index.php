...
<body>
    ...
    include 'bd/conexion.php';
      $personal = oci_parse($conn,"SELECT p.ID, p.APODO, p.SEXO, p.FECHANAC, p.FOTO ,r.NOMBRE FROM PERROS p INNER JOIN RAZAS r ON p.RAZA_ID=r.ID WHERE ROWNUM <= 8 AND VISIBLE = 'S'");
